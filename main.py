...
class CustomGUI(QMainWindow):
    def __init__(self):
        ...
        home_button.setIcon(QIcon("homebutton.png"))
        home_button.setIconSize(QSize(75, 75))
        home_button.setFixedSize(75, 75)
        home_button.setStyleSheet(button_style)
        home_button.clicked.connect(self.button_clicked)
        ...
        button6 = QPushButton()
        button6.setIcon(QIcon("settingsbutton.png"))
        button6.setIconSize(QSize(75, 75))
        button6.setFixedSize(75, 85)
